...
def parse_args():
    ...
    parser.add_argument('--loss_type', type=str, default="soft_entropy")
...
def main():
    ...
    for dataset in DATA_LIST:
        if dataset in TEST_DATA:
            ...
            data = get_dataset(dataset, train=True, prior=args.prior, prior_offset=args.prior_offset, protein_label_type="benchmark", pretrain_data_name=args.pretrain_data_name, loss_type=args.loss_type)
    ...
    for epoch in range(args.epochs):
        ...
        valid_loss = test(models, data_samplers, device, args.loss_type)
